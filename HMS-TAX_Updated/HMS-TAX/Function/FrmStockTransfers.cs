    ...
    public partial class FrmStockTransfers : KryptonForm
    {
        ...
        void FormatDataGridview()
        {
            try
            {
                ...
                //txtTypeCode
                this.dgPos.ColumnHeadersDefaultCellStyle.Font = new Font("Cooper Black", 16F, FontStyle.Bold, GraphicsUnit.Pixel);
                dgPos.ColumnHeadersDefaultCellStyle.ForeColor = Color.Red;

                this.dgPos.DefaultCellStyle.Font = new Font("Cooper Black", 15F, FontStyle.Italic, GraphicsUnit.Pixel);
